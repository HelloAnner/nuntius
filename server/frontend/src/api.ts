...
export const api = {
  ...
  createThread: (deviceId: string, projectId: string, title: string | null, firstMessage: string | null, idemKey: string) =>
    req<CommandReceipt>(
      "POST",
  ...
  startTurn: (threadId: string, text: string, idemKey: string) =>
